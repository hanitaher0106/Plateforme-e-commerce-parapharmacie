...
<html lang="en">
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="categories/produits/liste.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            print '<div class="alert alert-success">Produit ajouté avec success</div>';}
             ?>
             <?php
            //alert for delete
            if(isset($_GET['delete']) && $_GET['delete']== "ok"){
            print '<div class="alert alert-success">Produit supprimé avec success</div>'; }
               ?>      
            <?php
            //alert for update
            if(isset($_GET['modif']) && $_GET['modif']== "ok"){
              print '<div class="alert alert-success">Produit modifié avec success</div>'; }
            ?>
            <table class="table">
  <thead>
    <tr>
  ...
  <tbody>
      ...
      foreach($produits as $produit)
      {
          ...
          <td> 
              <a data-toggle="editModal" data-target="#editModal '.$produit['id_prod'].'" class="btn btn-success">Modifier  </a> 
              <a href="supprimer.php?idp='.$produit['id_prod'].'" class="btn btn-danger">Suppprimer </a> 
          </td>
        </tr> 
          ';
      }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="ajout.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group"> 
                  <input type="number" step="0.01" name="prix"  class="form-control" placeholder="Prix de categorie">
              </div> 
